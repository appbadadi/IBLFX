...
import { MenuIcon, WifiIcon, XIcon } from "@heroicons/react/outline";
    ...
    <div className="bg-white">
      <header>
        <div className="relative bg-white">
          ...
          <div className="flex justify-between items-center bg-violet-700 opacity-100 px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-32">
            <div className="flex justify-start lg:w-0 lg:flex-1">
              <a href="#">
